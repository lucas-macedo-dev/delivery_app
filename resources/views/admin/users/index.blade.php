        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-semibold mb-4 text-orange-600">
                        📋 Usuários Pendentes de Aprovação ({{ $pendingUsers->count() }})
                    </h3>
                    ...
                    @else
                        <p class="text-gray-500 dark:text-gray-400">Nenhum usuário pendente de aprovação.</p>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <form action="{{ route('admin.users.revoke', $user) }}" method="POST" class="inline"
                                                      onsubmit="return confirm('Tem certeza que deseja revogar o acesso deste usuário?');">
                                                    @csrf
                                                    @method('PATCH')
                    ...
                    @else
                        <p class="text-gray-500 dark:text-gray-400">Nenhum usuário aprovado ainda.</p>
                    @endif
                </div>
            </div>
        </div>
