        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="pt-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('delivery/shopping-lists') ? 'active' : '' }}"
                           href="{{ route('shopping-lists.index') }}" data-page="fee-expenses">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom" id="main_navbar">
                <div class="container-fluid">
                    ...
                    <div class="ms-auto">
                        @auth
                            <div class="dropdown">
                                <button class="btn bg-secondary-subtle text-dark me-2 dropdown-toggle" type="button"
